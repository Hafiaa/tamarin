        ...
        if (ServiceItem::count() === 0) {
            $serviceItems = [
                ...
                [
                    ...
                    'description' => 'Paket catering menengah untuk acara sedang (Nasi Liwet/Uduk, 2 Lauk Utama, 1 Ikan, 1 Sayur, 2 Snacks, 1 Dessert, Minuman)',
                    'price' => 75000,
                    'category' => 'catering',
                    'is_available' => true,
                ],
                [
                    ...
                    'description' => 'Paket catering premium untuk acara besar (Nasi Kuning/Liwet Premium, 3 Lauk, Sayur, Pelengkap, 3 Snacks, Dessert, Minuman Lengkap)',
                    'price' => 100000,
                    'category' => 'catering',
                    'is_available' => true,
                ],
                ...
                [
                    ...
                    'description' => 'Ruangan indoor dengan kapasitas 50 orang, dilengkapi AC dan sound system dasar',
                    'price' => 2000000,
                    'category' => 'venue',
                    'is_available' => true,
                ],
                [
                    ...
                    'description' => 'Area outdoor dengan kapasitas 100 orang, dilengkapi tenda dan sound system',
                    'price' => 3500000,
                    'category' => 'venue',
                    'is_available' => true,
                ],
                [
                    ...
                    'description' => 'Ruangan VIP dengan kapasitas 150 orang, dilengkapi AC, sound system premium, dan area khusus',
                    'price' => 5000000,
                    'category' => 'venue',
                    'is_available' => true,
                ],
                ...
                [
                    ...
                    'description' => 'Dekorasi standar dengan bunga, kain, dan lighting dasar',
                    'price' => 1500000,
                    'category' => 'decoration',
                    'is_available' => true,
                ],
                [
                    ...
                    'description' => 'Dekorasi premium dengan bunga segar, kain berkualitas, dan lighting lengkap',
                    'price' => 3000000,
                    'category' => 'decoration',
                    'is_available' => true,
                ],
                [
                    'name' => 'Dekorasi Mewah',
                    'description' => 'Dekorasi mewah dengan bunga impor, kain premium, dan lighting artistik',
                    'price' => 5000000,
                    'category' => 'decoration',
                    'is_available' => true,
                ],
                ...
                [
                    ...
                    'description' => 'Live music dengan format akustik (2 musisi)',
                    'price' => 1500000,
                ...
                [
                    ...
                    'description' => 'Live music dengan format full band (4-5 musisi)',
                    'price' => 3500000,
                    'category' => 'entertainment',
                    'is_available' => true,
                ],
                [
                    'name' => 'DJ Performance',
                    'description' => 'DJ performance dengan sound system lengkap',
                    'price' => 2500000,
                    'category' => 'entertainment',
                    'is_available' => true,
                ],
                ...
                [
                    ...
                    'description' => 'Layanan fotografi premium dengan 2 fotografer dan 1 videografer (6 jam)',
                    'price' => 3500000,
                    'category' => 'photography',
                    'is_available' => true,
                ],
                [
                    ...
                    'description' => 'Layanan fotografi lengkap dengan 2 fotografer, 2 videografer, drone, dan album (8 jam)',
                    'price' => 6000000,
                    'category' => 'photography',
                    'is_available' => true,
                ],
